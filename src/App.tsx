...
const App: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (countDown)
            localStorage.setItem("countDown", countDown > 0 ? countDown.toString() : "0")
    }, [countDown])
    ...
    const addHour = () => {
        if (isRunning)
            setEndDate(endDate.add(1, "hour"))
        else setCountDown(countDown + 3600)
    }
    const addFiveMins = () => {
        if (isRunning)
            setEndDate(endDate.add(5, "minutes"))
        ...
        <div className="app">
            ...
            <div className="buttons">
                ...
                <div className="row w-100">
                    ...
                    <button className="reset" onClick={addFiveMins}>Add 5 Minutes</button>
